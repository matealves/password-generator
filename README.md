...
Modelo de formulário moderno, onde é possível pedir para o site gerar uma ou mais senhas de **alta segurança** para que o usuário possa utilizar no momento do cadastro, senha essa que utiliza **_letras maiúsculas e minúsculas, números e simbolos_**, de forma totalmente aleatória. Também é possível copiar essa senha gerada pela página, com apenas um **clique** no botão _copiar_.
<br>
